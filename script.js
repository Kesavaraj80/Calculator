...
<div class="btns">
    ...
    <div class="buttons">
        <button class="btn" onclick="power2()">X<sup>2</sup></button>
        <button class="btn" onclick="power3()">X<sup>3</sup></button>
        <button class="btn" onclick="display('%')">%</button>
        <button class="btn" onclick="display('/')">/</button>
    </div>
    <div class="buttons">
...
function power2(){
    let pval2 = document.getElementById('box1').value;
    document.getElementById('box1').value=Math.pow(pval2,2).toFixed(2);
}
function power3(){
    let pval3 = document.getElementById('box1').value;
    document.getElementById('box1').value=Math.pow(pval3,3).toFixed(2);
}